...
router.post("/register", async (req, res) => {
    try {
        ...
        const result = await authService.register(data.email, data.password, data.firstName, data.lastName, data.signature, data.role, requestingUserRole);
 ...
 */
router.patch("/admin/users/:userId/role", authMiddleware, requireRole("admin"), async (req, res) => {
    try {
 ...
 */
router.get("/admin/dashboard", authMiddleware, requireRole("admin"), (_req, res) => {
