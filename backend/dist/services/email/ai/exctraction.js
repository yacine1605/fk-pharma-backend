...
export function extractOfferData(text) {
...
function findPercentage(text, labels) {
    for (const label of labels) {
...
function findMonths(text, labels) {
    for (const label of labels) {
...
function detectCurrency(text) {
    if (text.includes("dzd") || text.includes("da"))
        return "DZD";
...
//# sourceMappingURL=exctraction.js.map