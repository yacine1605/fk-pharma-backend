...
export const distributorsService = {
    ...
    async updateDistributor(distributorId, data) {
        ...
        if (data.creditLimit)
            updateData.creditLimit = parseFloat(data.creditLimit);
    ...
    async rateDistributor(distributorId, userId, rating) {
...
//# sourceMappingURL=distributeurService.js.map