...
export const offerAttachments = pgTable(
  "offer_attachments",
  {
...
export const offerAttachmentsRelations = relations(
  offerAttachments,
  ({ one }) => ({
    offer: one(offers, {
...
export const supplierResponses = pgTable(
  "supplier_responses",
  {
    ...
    offerSupplierId: uuid("offer_supplier_id").references(
      () => offerSuppliers.id,
      { onDelete: "set null" },
    ),
  ...
  (table) => [
    ...
    uniqueIndex("supplier_responses_email_message_uidx").on(
      table.emailMessageId,
    ),
  ],
);

export const supplierResponseAttachments = pgTable(
  ...
  (table) => [
    index("supplier_response_attachments_response_id_idx").on(
      table.supplierResponseId,
    ),
...
export const supplierProformaLines = pgTable(
  "supplier_proforma_lines",
  {
    id: uuid("id").defaultRandom().primaryKey(),
...
export const supplierItemAnalyses = pgTable(
  "supplier_item_analyses",
  {
    id: uuid("id").defaultRandom().primaryKey(),
    supplierResponseId: uuid("supplier_response_id")
      .notNull()
    ...
    proformaLineId: uuid("proforma_line_id").references(
      () => supplierProformaLines.id,
      { onDelete: "set null" },
    ),
  ...
  (table) => [
    index("supplier_item_analyses_response_id_idx").on(
      table.supplierResponseId,
    ),
...
export const supplierGlobalAnalyses = pgTable(
  "supplier_global_analyses",
  {
    id: uuid("id").defaultRandom().primaryKey(),
    supplierResponseId: uuid("supplier_response_id")
      .notNull()
...
export const notifications = pgTable(
  "notifications",
  {
    ...
    supplierResponseId: uuid("supplier_response_id").references(
  ...
  (table) => [
    ...
    index("notifications_supplier_response_id_idx").on(
      table.supplierResponseId,
    ),
...
export const offerFinalSelections = pgTable("offer_final_selections", {
  ...
  supplierItemAnalysisId: uuid("supplier_item_analysis_id").references(
    () => supplierItemAnalyses.id,
    { onDelete: "set null" },
  ),
...
export const offers = pgTable(
  "offers",
  {
    ...
    technicalDepartmentDepositDate: timestamp(
      "technical_department_deposit_date",
      {
        withTimezone: true,
      },
    ),
    ...
    provisionalAttributionPV: boolean("provisional_attribution_pv").default(
      false,
    ),
    definitiveAttributionPV: boolean("definitive_attribution_pv").default(
      false,
    ),
...
export const supplierResponsesRelations = relations(
  supplierResponses,
  ({ one, many }) => ({
    offer: one(offers, {
...
export const supplierResponseAttachmentsRelations = relations(
...
export const supplierProformasRelations = relations(
  supplierProformas,
  ({ one, many }) => ({
    supplierResponse: one(supplierResponses, {
...
export const supplierProformaLinesRelations = relations(
...
export const supplierItemAnalysesRelations = relations(
...
export const supplierGlobalAnalysesRelations = relations(
...
export const offerLots = pgTable(
  "offer_lots",
  {
    id: uuid("id").defaultRandom().primaryKey(),
    offerId: uuid("offer_id")
...
export const offerSuppliersRelations = relations(
  offerSuppliers,
  ({ one, many }) => ({
    offer: one(offers, {
...
export const offerExcelExports = pgTable(
  "offer_excel_exports",
  {
    id: uuid("id").defaultRandom().primaryKey(),
    offerId: uuid("offer_id")
...
export const offerDocumentFolderFiles = pgTable(
  "offer_document_folder_files",
  {
    id: uuid("id").defaultRandom().primaryKey(),
    ...
    supplierResponseAttachmentId: uuid(
      "supplier_response_attachment_id",
...
export const offerDocumentFolders = pgTable(
  "offer_document_folders",
  {
    id: uuid("id").defaultRandom().primaryKey(),
    offerId: uuid("offer_id")
      .notNull()
    ...
    parentId: uuid("parent_id").references(
      (): AnyPgColumn => offerDocumentFolders.id,
      { onDelete: "cascade" },
    ),
    createdAt: timestamp("created_at", { withTimezone: true })
      .defaultNow()
...
export const offerFinalSelectionsRelations = relations(
  offerFinalSelections,
  ({ one }) => ({
    offer: one(offers, {
...
export const supplierCategoryLinksRelations = relations(
...
export const offerDocumentFoldersRelations = relations(
...
export const offerDocumentFolderFilesRelations = relations(
